      ...
      <div class="col-md-4 offset-md-4">
        <div class="card">
          <div class="card-content">
            ...
            >
              <font style="vertical-align: inherit">
                <font style="vertical-align: inherit">Regístrate</font>
              </font>
            </nuxt-link>
          </div>
        </div>
...
export default {
  data: () => {
    return {
      user: { identifier: 'pizza@email.com', password: 'pizzapizza' },
      error: null,
      loading: false,
    }
  },
  methods: {
    async handleSubmit() {
      try {
        ...
        this.$store.commit('cart/setItems', cart)
        this.$router.push('/')
      } catch (error) {
